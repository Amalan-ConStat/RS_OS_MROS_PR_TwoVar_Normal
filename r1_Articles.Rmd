...
Identical_ro$Model<-factor(Identical_ro$Model,
                           levels = c("mMSE DM","mMSE AM 1","mMSE AM 2","mMSE AM 3",
...
Identical_ro[Identical_ro$Metric=="Model Information" & Identical_ro$Model %in% Selected_Models_mMSE,] %>%
  ggplot(.,aes(x=Subsample_Size,y=`Estimated Values`,color=Model,linetype=Model))+
  ...
  xlab(expression(paste(r[0],' + ',r[1],'=1000 and ',r[0])))+
...
Identical_ro[Identical_ro$Metric=="Model Information" & Identical_ro$Model %in% Selected_Models_mMSE,] %>%
  ggplot(.,aes(x=Subsample_Size,y=log(`Estimated Values`),color=Model,linetype=Model))+
  scale_x_continuous(labels = unique(Identical_ro$Subsample_Size),
                     breaks = unique(Identical_ro$Subsample_Size))+
...
ggarrange(p1,p3,nrow = 2,ncol = 1,legend.grob = Temp_legend_mMSE,legend = "bottom",labels = "auto") %>%
  ggexport(filename = here("Article_Plots","r1_SMSE_MI_PR_TV_Nor_mMSE.pdf"),res=300,width = 12,height = 16)
ggarrange(p2,p4,nrow = 2,ncol = 1,legend.grob = Temp_legend_mVc,legend = "bottom",labels = "auto") %>%
  ggexport(filename = here("Article_Plots","r1_SMSE_MI_PR_TV_Nor_mVc.pdf"),res=300,width = 12,height = 16)
ggarrange(p5,nrow = 1,ncol = 1,legend.grob = Temp_legend_mMSE,legend = "bottom") %>%
  ggexport(filename = here("Article_Plots","r1_ACCURACY_PR_TV_Nor_mMSE.pdf"),res=300,width = 12,height = 12)
ggarrange(p6,nrow = 1,ncol = 1,legend.grob = Temp_legend_mVc,legend = "bottom") %>%
  ggexport(filename = here("Article_Plots","r1_ACCURACY_PR_TV_Nor_mVc.pdf"),res=300,width = 12,height = 12)

ggarrange(p7,nrow = 1,ncol = 1,legend.grob = Temp_legend_mMSE,legend = "bottom") %>%
  ggexport(filename = here("Article_Plots","r1_SMSE_for_MLE_MI_PR_TV_Nor_mMSE.pdf"),res=300,width = 12,height = 12)
ggarrange(p8,nrow = 1,ncol = 1,legend.grob = Temp_legend_mVc,legend = "bottom") %>%
  ggexport(filename = here("Article_Plots","r1_SMSE_for_MLE_MI_PR_TV_Nor_mVc.pdf"),res=300,width = 12,height = 12)

ggarrange(p1,p3,nrow = 2,ncol = 1,legend.grob = Temp_legend_mMSE,legend = "bottom",labels = "auto") %>%
  ggsave(filename = here("Article_Plots","r1_SMSE_MI_PR_TV_Nor_mMSE.eps"),device="eps",dpi=300,width = 12,height = 16)
ggarrange(p2,p4,nrow = 2,ncol = 1,legend.grob = Temp_legend_mVc,legend = "bottom",labels = "auto") %>% 
  ggsave(filename = here("Article_Plots","r1_SMSE_MI_PR_TV_Nor_mVc.eps"),device="eps",dpi=300,width = 12,height = 16)
ggarrange(p5,nrow = 1,ncol = 1,legend.grob = Temp_legend_mMSE,legend = "bottom") %>%
  ggsave(filename = here("Article_Plots","r1_ACCURACY_PR_TV_Nor_mMSE.eps"),device="eps",dpi=300,width = 12,height = 12)
ggarrange(p6,nrow = 1,ncol = 1,legend.grob = Temp_legend_mVc,legend = "bottom") %>%
  ggsave(filename = here("Article_Plots","r1_ACCURACY_PR_TV_Nor_mVc.eps"),device="eps",dpi=300,width = 12,height = 12)

ggarrange(p7,nrow = 1,ncol = 1,legend.grob = Temp_legend_mMSE,legend = "bottom") %>%
  ggexport(filename = here("Article_Plots","r1_SMSE_for_MLE_MI_PR_TV_Nor_mMSE.eps"),res=300,width = 12,height = 12)
ggarrange(p8,nrow = 1,ncol = 1,legend.grob = Temp_legend_mVc,legend = "bottom") %>%
  ggexport(filename = here("Article_Plots","r1_SMSE_for_MLE_MI_PR_TV_Nor_mVc.eps"),res=300,width = 12,height = 12)
```
