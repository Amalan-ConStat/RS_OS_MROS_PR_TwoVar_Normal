...
Run_OSMAC<-function(Replicates,r1,r2,Y,X,Real_Data,N,Model)
{
  ...
  save(list= c("Results_OSMAC","Bias_OSMAC","Utility_OSMAC"#,"Sample_OSMAC"
       ...
       file = here("Non_Identical_r0","Simulation_Setup","Analysis","OSMAC","Results",Model,"OSMAC_output.RData"))

  save(list = c("Results_OSMAC","Bias_OSMAC","Utility_OSMAC"#,"Sample_OSMAC"
                ),
       file = here("Non_Identical_r0","Outputs",Model_Path,"OSMAC",Model,"OSMAC_output.RData"))
}
...
save(list =c("Run_OSMAC","AlgTwoStp","Cordeiro"),
     file=here("Non_Identical_r0","Simulation_Setup","Analysis","OSMAC","Run_OSMAC.RData"))
