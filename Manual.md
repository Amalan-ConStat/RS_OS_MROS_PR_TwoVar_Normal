---
title: "Manual of comparing optimal subsampling with model robust optimal subsampling method for poisson regression (standardised Multivariate Normal distribution)"
output: 
  html_document:
    keep_md: yes
---
...
* Based on the real model of the poisson regression data we have four folders and in each folder their respective Big Data sets are stored by using ***Checking_SP_Model_1_Normal_Special.R***.
...
2. $\theta=[1.0,-0.3, 0.3, 0.1]$ generates data for Model 2 of $x_1,x_2,x^2_1$.
3. $\theta=[1.0, 0.3,-0.3, 0.1]$ generates data for Model 3 of $x_1,x_2,x^2_2$.
4. $\theta=[1.0, 0.3, 0.3,-0.3, 0.1]$ generates data for Model 4 of $x_1,x_2,x^2_1,x^2_2$.

* For each model structure covariate data was generated only through standardised Multivariate Normal distribution. 
...
* Use **Articles.Rmd** to generate plots relevant to the paper as pdf files **Article_Plots/SMSE_MI_PR_TV_Nor_mMSE.pdf** and **Article_Plots/SMSE_MI_PR_TV_Nor_mVc.pdf**. 
