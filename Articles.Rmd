...
Selected_Models_mMSE<-c("Random Sampling: Data Model",
                        ...
                        "Optimal subsampling mMSE: Data Model",
...
Selected_Models_mVc<-c("Random Sampling: Data Model",
                       ...
                       #"Random Sampling: Incorrect Model 2",
                       #"Random Sampling: Incorrect Model 3",
                       "Optimal subsampling mVc: Data Model",
...
# ggarrange(p1,p3,nrow = 2,ncol = 1,legend.grob = Temp_legend_mMSE,legend = "bottom",labels = "auto") %>%
#   ggexport(filename = here("Article_Plots","SMSE_MI_PR_TV_Nor_mMSE.pdf"),res=300,width = 12,height = 16)
ggarrange(p3,nrow = 1,ncol = 1,legend.grob = Temp_legend_mMSE,legend = "bottom") %>%
  ggexport(filename = here("Article_Plots","SMSE_MI_PR_TV_Nor_mMSE.pdf"),res=300,width = 12,height = 12)
# ggarrange(p2,p4,nrow = 2,ncol = 1,legend.grob = Temp_legend_mVc,legend = "bottom",labels = "auto") %>%
#   ggexport(filename = here("Article_Plots","SMSE_MI_PR_TV_Nor_mVc.pdf"),res=300,width = 12,height = 16)
ggarrange(p4,nrow = 1,ncol = 1,legend.grob = Temp_legend_mVc,legend = "bottom") %>%
  ggexport(filename = here("Article_Plots","SMSE_MI_PR_TV_Nor_mVc.pdf"),res=300,width = 12,height = 12)
ggarrange(p5,nrow = 1,ncol = 1,legend.grob = Temp_legend_mMSE,legend = "bottom") %>%
  ggexport(filename = here("Article_Plots","ACCURACY_PR_TV_Nor_mMSE.pdf"),res=300,width = 12,height = 12)
ggarrange(p6,nrow = 1,ncol = 1,legend.grob = Temp_legend_mVc,legend = "bottom") %>%
  ggexport(filename = here("Article_Plots","ACCURACY_PR_TV_Nor_mVc.pdf"),res=300,width = 12,height = 12)

ggarrange(p7,nrow = 1,ncol = 1,legend.grob = Temp_legend_mMSE,legend = "bottom") %>%
  ggexport(filename = here("Article_Plots","SMSE_for_MLE_MI_PR_TV_Nor_mMSE.pdf"),res=300,width = 12,height = 12)
ggarrange(p8,nrow = 1,ncol = 1,legend.grob = Temp_legend_mVc,legend = "bottom") %>%
  ggexport(filename = here("Article_Plots","SMSE_for_MLE_MI_PR_TV_Nor_mVc.pdf"),res=300,width = 12,height = 12)

ggarrange(p1,p3,nrow = 2,ncol = 1,legend.grob = Temp_legend_mMSE,legend = "bottom",labels = "auto") %>%
  ggsave(filename = here("Article_Plots","SMSE_MI_PR_TV_Nor_mMSE.eps"),device="eps",dpi=300,width = 12,height = 16)
ggarrange(p2,p4,nrow = 2,ncol = 1,legend.grob = Temp_legend_mVc,legend = "bottom",labels = "auto") %>% 
  ggsave(filename = here("Article_Plots","SMSE_MI_PR_TV_Nor_mVc.eps"),device="eps",dpi=300,width = 12,height = 16)
ggarrange(p5,nrow = 1,ncol = 1,legend.grob = Temp_legend_mMSE,legend = "bottom") %>%
  ggsave(filename = here("Article_Plots","ACCURACY_PR_TV_Nor_mMSE.eps"),device="eps",dpi=300,width = 12,height = 12)
ggarrange(p6,nrow = 1,ncol = 1,legend.grob = Temp_legend_mVc,legend = "bottom") %>%
  ggsave(filename = here("Article_Plots","ACCURACY_PR_TV_Nor_mVc.eps"),device="eps",dpi=300,width = 12,height = 12)

ggarrange(p7,nrow = 1,ncol = 1,legend.grob = Temp_legend_mMSE,legend = "bottom") %>%
  ggexport(filename = here("Article_Plots","SMSE_for_MLE_MI_PR_TV_Nor_mMSE.eps"),res=300,width = 12,height = 12)
ggarrange(p8,nrow = 1,ncol = 1,legend.grob = Temp_legend_mVc,legend = "bottom") %>%
  ggexport(filename = here("Article_Plots","SMSE_for_MLE_MI_PR_TV_Nor_mVc.eps"),res=300,width = 12,height = 12)
```
