...
M1_Identical_r0<-rbind(cbind.data.frame(Covariate="Data Model: X1, X2",Metric="Model Information",
                                        All_Info),
                       cbind.data.frame(Covariate="Data Model: X1, X2",Metric="MSE",
                                        All_MSE))
...
M2_Identical_r0<-rbind(cbind.data.frame(Covariate="Data Model: X1, X2, X1\u00B2",Metric="Model Information",
                                        All_Info),
                       cbind.data.frame(Covariate="Data Model: X1, X2, X1\u00B2",Metric="MSE",
                                        All_MSE))
...
M3_Identical_r0<-rbind(cbind.data.frame(Covariate="Data Model: X1, X2, X2\u00B2",Metric="Model Information",
                                        All_Info),
                       cbind.data.frame(Covariate="Data Model: X1, X2, X2\u00B2",Metric="MSE",
                                        All_MSE))
...
M4_Identical_r0<-rbind(cbind.data.frame(Covariate="Data Model: X1, X2, X1\u00B2, X2\u00B2",Metric="Model Information",
                                        All_Info),
                       cbind.data.frame(Covariate="Data Model: X1, X2, X1\u00B2, X2\u00B2",Metric="MSE",
                                        All_MSE))
...
Identical_ro$Covariate<-factor(Identical_ro$Covariate,
                               levels = c("Data Model: X1, X2",
                                          "Data Model: X1, X2, X1\u00B2",
                                          "Data Model: X1, X2, X2\u00B2",
                                          "Data Model: X1, X2, X1\u00B2, X2\u00B2"))
...
Identical_ro$Model<-recode_factor(Identical_ro$Model,
                                  ...
                                  `mVc DM`="Optimal Sub-sampling mVc: Data Model 1",
...
Selected_Models_mVc<-c("Random Sampling: Data Model",
                       ...
                       #"Random Sampling: Incorrect Model 2",
                       #"Random Sampling: Incorrect Model 3",
                       "Optimal Sub-sampling mVc: Data Model 1",
...
Identical_ro[Identical_ro$Metric=="Model Information" & Identical_ro$Model %in% Selected_Models_mMSE,] %>%
  ...
  ylab("Model Information")+expand_limits(y = 0)+
  ...
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1),
        ...
        axis.title.y = element_text(color = "black",face = "bold",size = 12))->Temp_plot_mMSE
...
Identical_ro[Identical_ro$Metric=="Model Information" & Identical_ro$Model %in% Selected_Models_mVc,] %>%
  ...
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1),
        panel.grid.minor.x = element_blank(),
        axis.title.x = element_text(color = "black",face = "bold",size = 12),
        axis.title.y = element_text(color = "black",face = "bold",size = 12))->Temp_plot_mVc
...
Identical_ro[Identical_ro$Metric=="Model Information" & Identical_ro$Model %in% Selected_Models_mMSE,] %>%
  ...
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1),
        panel.grid.minor.x = element_blank(),
        axis.title.x = element_text(color = "black",face = "bold",size = 12),
        axis.title.y = element_text(color = "black",face = "bold",size = 12))->p1
...
Identical_ro[Identical_ro$Metric=="Model Information" & Identical_ro$Model %in% Selected_Models_mVc,] %>%
  ...
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1),
        panel.grid.minor.x = element_blank(),
        axis.title.x = element_text(color = "black",face = "bold",size = 12),
        axis.title.y = element_text(color = "black",face = "bold",size = 12))->p2
...
Identical_ro[Identical_ro$Metric=="MSE" & Identical_ro$Model %in% Selected_Models_mMSE,] %>%
  ...
  facet_wrap(~Covariate,scales = "free_y",ncol = 4)+
  xlab(expression(paste(r[0],' = 100 and r')))+
  ylab("SMSE")+expand_limits(y = 0)+
  scale_y_continuous(breaks = scales::pretty_breaks(n = length(unique(Identical_ro$Subsample_Size))/2))+
  theme_bw()+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1),
        panel.grid.minor.x = element_blank(),
        axis.title.x = element_text(color = "black",face = "bold",size = 12),
        axis.title.y = element_text(color = "black",face = "bold",size = 12))->p3
...
Identical_ro[Identical_ro$Metric=="MSE" & Identical_ro$Model %in% Selected_Models_mVc,] %>%
  ...
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1),
        panel.grid.minor.x = element_blank(),
        axis.title.x = element_text(color = "black",face = "bold",size = 12),
        axis.title.y = element_text(color = "black",face = "bold",size = 12))->p4

ggarrange(p1,p3,nrow = 2,ncol = 1,legend.grob = Temp_legend_mMSE,legend = "bottom")
ggarrange(p2,p4,nrow = 2,ncol = 1,legend.grob = Temp_legend_mVc,legend = "bottom")
```
